    ...
    const content = `
      ...
      <div class="header">
        ...
        <div class="header-left">
          ...
          <div class="company">${companyName || "FeedFlow ERP"}</div>
      ...
      <div class="footer">
        <p><span class="footer-logo">${companyName || "FeedFlow ERP"}</span> — ${t("جميع الحقوق محفوظة", "All rights reserved")} © ${new Date().getFullYear()}</p>
        <p style="margin-top:2px">${t("تم إنشاؤه بواسطة", "Generated by")} FeedFlow ERP — ${nowStr}</p>
      </div>
    `;
    ...
    const content = `
      <div class="inv-header">
        ...
        <div class="left">
          ...
          <div><strong>${companyName || "FeedFlow ERP"}</strong></div>
          ${companyAddress ? `<div>${companyAddress}</div>` : ""}
        </div>
      </div>
      <div class="inv-info">
      ...
      <div class="footer">
        <p>${companyName || "FeedFlow ERP"} — ${t("جميع الحقوق محفوظة", "All rights reserved")} © ${new Date().getFullYear()}</p>
